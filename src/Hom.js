  ...
  return (
    <div>
      ...
      <map id="iraq" name="iraq">
        ...
        <area
          shape="poly"
          coords="266,47,235,79,206,85,195,100,196,127,199,139,199,160,
        194,170,188,196,210,200,233,213,252,213,270,215,272,203,
        307,201,298,176,316,161,327,152,330,135,338,127,359,
        97,378,81,393,70,378,61,363,50,350,48,355,56,348,61,
        336,59,329,53,322,68,305,71,294,72,279,65,269,47"
          alt="Sun"
          href="#"
          onClick={() => console.log("mosol")}
        />
        <area
          shape="poly"
          coords="393,233,334,197,325,179,345,177,348,169,357,168,
        360,152,369,145,380,150,384,145,413,142,423,157,
        426,176,418,197,407,205,409,212,400,221"
          alt="Sun"
          href="#"
          onClick={() => console.log("karkok")}
        />
        <area
          shape="poly"
          uu
          coords="365,49,381,62,394,69,376,83,361,97,339,126,331,131,
          334,135,329,147,332,172,346,173,356,167,358,155,368,142,
          382,149,385,142,411,142,418,139,438,140,431,133,
          415,120,419,113,408,103,416,94,439,87,444,75,434,67,
          428,69,434,56,425,40,414,35,400,,44,393,52,387,41,
          392,31,380,25"
          alt="Sun"
          href="#"
          onClick={() => console.log("erbil")}
        />
        <area
          shape="poly"
          uu
          coords="376,22,380,32,363,47,350,47,349,51,356,54,350,61,
          337,58,328,53,320,67,306,69,293,71,284,65,276,55,
          268,40,278,38,295,20,317,21,331,24,346,31,362,33,377,24"
          alt="Sun"
          href="#"
          onClick={() => console.log("dhok")}
        />
        <area
          shape="poly"
          uu
          coords="492,218,490,194,478,222,455,251,456,229,446,225,439,221,
          437,215,427,210,418,208,411,202,419,198,426,177,425,156,
          417,143,433,141,438,133,429,130,416,119,421,112,409,
          100,428,94,441,91,446,98,457,98,463,122,463,133,475,131,
          487,139,491,147,514,141,528,145,515,153,508,158,504,168,
          518,196,510,205,503,204"
          alt="Sun"
          href="#"
          onClick={() => console.log("slamana")}
        />
      </map>
      <Karbala
        open={isKarbala}
